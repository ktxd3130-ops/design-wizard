...
export function TextPanel({ fabricRef }: TextPanelProps) {
    ...
    return (
        <div className="flex-1 overflow-y-auto p-6 space-y-8">
            ...
            <p className="text-[11px] text-[var(--ui-30)] uppercase tracking-wider font-semibold mt-2 mb-4">Default text styles</p>
            ...
            <p className="text-[11px] text-[var(--ui-30)] uppercase tracking-wider font-semibold mt-2 mb-4">Dynamic text</p>
            ...
            <p className="text-[11px] text-[var(--ui-30)] uppercase tracking-wider font-semibold mt-2 mb-4 border-t border-[var(--ui-5)] pt-8">Font combinations</p>
            <div className="space-y-4">
                {[

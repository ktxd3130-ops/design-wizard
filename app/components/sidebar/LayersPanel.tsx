    ...
    return (
        <div className="flex-1 flex flex-col overflow-hidden">
            <div className="p-4 border-b border-white/5 bg-[#252536] z-10 shrink-0 flex items-center justify-between">
                ...
                <span className="text-[10px] text-white/40">{layers.length} layers</span>
            </div>
            <div className="flex-1 overflow-y-auto p-2 space-y-1">
                {layers.map((layer: any, idx) => {
                    ...
                    return (
                        <div
                            ...
                            className={`flex items-center gap-2 px-2 py-2 rounded-lg border transition-all cursor-pointer group ${
                                isActive
                        ...
                        >
                            {/* Drag handle */}
                            <div className="text-white/20 group-hover:text-white/40 cursor-grab">
                            ...
                            <div className="flex-1 min-w-0">
                                {editingId === layer.id ? (
                                    <input
                                        ...
                                        className="w-full bg-white/10 text-xs text-white/90 px-1.5 py-0.5 rounded outline-none border border-violet-500/50"
                            ...
                            <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
                                ...
                                <button
                                    ...
                                    className={`p-1 rounded transition-colors ${layer.locked ? 'text-red-400' : 'text-white/30 hover:text-white'}`}
                ...
                {layers.length === 0 && (
                    <div className="text-center py-10 opacity-50">
                        ...
                        <p className="text-[10px] text-white/30 mt-1">Add elements to see them here</p>
                    </div>
                )}
            </div>
        </div>

  ...
  return (
    <label className="flex flex-col gap-0.5">
      ...
      <div className="relative">
        <input
          type="number"
          className="w-full bg-white/10 border border-white/5 rounded text-xs text-white/80 px-2 py-1 pr-6 appearance-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
...
export default function InspectorPanel({ fabricRef, designState }: InspectorPanelProps) {
  ...
  if (!selectedObject) {
    return (
      <div className="w-full h-full bg-[#252536] text-white overflow-y-auto">
        <div className="p-4 border-b border-white/5">
          ...
          <label className="flex items-center gap-2 text-xs text-white/70">
            ...
            <input
              type="color"
              className="ml-auto w-7 h-7 rounded border border-white/10 bg-transparent cursor-pointer"
    ...
    <div className="w-full h-full bg-[#252536] text-white overflow-y-auto">
      ...
      <div className="p-4 border-b border-white/5">
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <span className="text-xs text-white/60 w-8 text-right">{currentOpacity}%</span>
        </div>
      </div>
      ...
      {isText && (
        <>
          ...
          <div className="p-4 border-b border-white/5">
            ...
            <select
              className="w-full bg-white/10 border border-white/5 rounded text-xs text-white/80 px-2 py-1.5 mb-2"
            ...
            <div className="grid grid-cols-2 gap-2 mb-2">
              ...
              <label className="flex flex-col gap-0.5">
                ...
                <select
                  className="w-full bg-white/10 border border-white/5 rounded text-xs text-white/80 px-2 py-1"
      ...
      {isImage && (
        <div className="p-4 border-b border-white/5">
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-xs text-white/60 hover:text-white/80 bg-white/5 hover:bg-white/10 rounded px-2.5 py-1.5 transition-colors"
          >
            <Eraser size={12} />
            Reset Filters
          </button>
